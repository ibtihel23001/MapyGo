...
import { list, getOne, create, update, updateStatus, remove, exportCsv } from './tickets.controller';

const router = Router();
router.use(authenticate);

router.get('/export', authorize('superadmin', 'admin', 'accountant'), exportCsv);
